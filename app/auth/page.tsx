...
export default function AuthPage() {
  ...
  const [isLoginView, setIsLoginView] = useState(true) // New state to toggle between login and signup
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 to-purple-700 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>{isLoginView ? "Sign in to your account" : "Create a new account"}</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoginView ? (
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="text-center text-sm text-gray-600 mt-4">
                ...
                <button type="button" onClick={() => setIsLoginView(false)} className="text-blue-600 hover:underline">
                  Sign Up
                </button>
              </div>
            </form>
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <div className="text-center text-sm text-gray-600 mt-4">
                ...
                <button type="button" onClick={() => setIsLoginView(true)} className="text-blue-600 hover:underline">
                  Sign In
                </button>
              </div>
            </form>
